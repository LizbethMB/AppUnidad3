...
class OrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post ordens_url, params: { orden: { cliente: @orden.cliente, fecha: @orden.fecha, numero: @orden.numero, references: @orden.references } }
    end
  ...
  test "should update orden" do
    patch orden_url(@orden), params: { orden: { cliente: @orden.cliente, fecha: @orden.fecha, numero: @orden.numero, references: @orden.references } }
